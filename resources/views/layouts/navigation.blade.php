        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('front.index') }}" >
                        {{--  <x-application-logo class="block h-9 w-auto fill-current text-gray-800" />
                          ...
                          <img width="60"  src="{{asset($settings['site_logo'])}}">
                          @else
                            Charitize
                          @endisset
                ...
                <div class="hidden space-x-2 sm:-my-px sm:ms-6 sm:flex">
                    <x-nav-link class="{{app()->getLocale()=='ar' ? 'me-4' :'' }}" :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        {{ __('admin.dash') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('dashboard.causes.index')" :active="request()->routeIs('dashboard.causes.index')">
                        {{ __(key: 'admin.cases') }}
                    </x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('dashboard.donners')">
                            {{ __('Donners') }}
                        </x-dropdown-link>
